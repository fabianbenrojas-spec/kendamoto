...
const hitos = [
  ...
  { year: '2000', title: 'Llegada a Chile', desc: 'Carioca Chile Ltda. se convierte en el distribuidor oficial exclusivo de Kenda Tires para el mercado chileno, operando desde la Zona Franca de Iquique (ZOFRI).' },
        ...
        <div className="wrap" style={{ maxWidth: '800px' }}>
          ...
          <div style={{ marginTop: '48px', background: 'var(--cream)', border: '1px solid var(--line)', padding: '32px' }}>
            ...
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '15px', color: 'var(--muted)', lineHeight: 1.8 }}>
              Carioca Chile Ltda. mantiene más de 200 referencias Kenda en stock permanente en nuestra bodega de la Zona Franca de Iquique (ZOFRI). Con más de 25 años como distribuidor exclusivo, somos el punto de entrada oficial de Kenda Tires al mercado chileno.
            </p>
          </div>
        </div>
      </section>
