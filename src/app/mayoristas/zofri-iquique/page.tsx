          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '48px', alignItems: 'start', marginBottom: '64px' }}>
            <div>
              ...
              <p style={{ fontFamily: 'var(--font-body)', fontSize: '15px', color: 'var(--muted)', lineHeight: 1.8 }}>
                Carioca Chile Ltda. opera en ZOFRI desde el año 2000. En 25 años hemos construido una cadena de suministro directa con Kenda Rubber Industrial Co., Ltd. (Taiwan) que nos permite ofrecer los precios más competitivos del mercado chileno, sin pasar por distribuidores regionales ni intermediarios.
              </p>
            </div>
